...
public class EggTest {
    ...
    public void numeroCapicuaTest() {
        assertEquals(true, pr.numeroPalindromo(123454321));
        assertEquals(true, pr.numeroPalindromo(-123454321));
        assertEquals(true, pr.numeroPalindromo(2));
        assertEquals(true, pr.numeroPalindromo(0));
        assertEquals(false, pr.numeroPalindromo(null));
        assertEquals(false, pr.numeroPalindromo(231));
        assertEquals(false, pr.numeroPalindromo(123));
        assertEquals(false, pr.numeroPalindromo(Integer.MAX_VALUE));
    }
}
